            ...
            <div className="w-full bg-gradient-to-br from-blue-500 to-indigo-600 rounded-md shadow-md overflow-hidden">
                <div className="p-6 md:p-8">
                    <div className="flex justify-between items-start md:items-center gap-4 mb-6">
                        ...
                        <button className="px-3 py-3 bg-white text-blue-600 rounded-md font-semibold hover:bg-blue-50 transition-all shadow-md flex items-center gap-2 group">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex  justify-between items-center gap-2 pt-2">
                            <div className="flex items-baseline gap-2">
                                <span className="text-lg font-bold text-white">32 GB</span>
